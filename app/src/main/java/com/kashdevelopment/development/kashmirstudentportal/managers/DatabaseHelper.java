package com.kashdevelopment.development.kashmirstudentportal.managers;
...
import com.kashdevelopment.development.kashmirstudentportal.ApplicationHelper;
...
import com.kashdevelopment.development.kashmirstudentportal.managers.listeners.OnPostListChangedListener;
import com.kashdevelopment.development.kashmirstudentportal.managers.listeners.OnProfileCreatedListener;
...
//        Sets the maximum time to retry upload operations if a failure occurs.
    ...
    public Task<Void> removeImage(String imageTitle) {
        StorageReference storageRef = storage.getReferenceFromUrl("gs://firstnetwork-c9f74.appspot.com/");
